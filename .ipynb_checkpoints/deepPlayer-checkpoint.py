...
class DQNPlayer(Player):
    ...
    def __init__(self, name, memory, 
             ...
             eps=1, eps_decrease = 0.01, eps_min = 0.01, alpha = 0, print_player = False, beta = 0.7, beta_increase = 1/10000, use_IS = True, PER = True, batch_size = 64, cond = 0):
        self.name = name
        self.memory = memory
